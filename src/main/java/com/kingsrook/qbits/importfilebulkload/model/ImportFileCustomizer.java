...
package com.kingsrook.qbits.importfilebulkload.model;
...
public class ImportFileCustomizer implements TableCustomizerInterface
{
   ...
   public List<QRecord> postQuery(QueryOrGetInputInterface queryInput, List<QRecord> records) throws QException
   {
      ...
      if(sourceQBitConfig instanceof ImportFileBulkLoadQBitConfig importFileBulkLoadQBitConfig)
      {
         stagingFileTableName = importFileBulkLoadQBitConfig.getEffectiveStagingFileTableName();
      }
