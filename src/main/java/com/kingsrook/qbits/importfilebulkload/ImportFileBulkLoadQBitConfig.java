...
import com.kingsrook.qbits.importfilebulkload.metadata.SFTPImportSourceFileTableMetaDataProducer;
import com.kingsrook.qbits.importfilebulkload.metadata.SFTPImportStagingFileTableMetaDataProducer;
 ...
 **
 *******************************************************************************/
public class ImportFileBulkLoadQBitConfig implements QBitConfig
{
    ...
    *******************************************************************************/
   public ImportFileBulkLoadQBitConfig withProcessTracerCodeReference(QCodeReference processTracerCodeReference)
   {
      this.processTracerCodeReference = processTracerCodeReference;
      return (this);
   }
    ...
    *******************************************************************************/
   public ImportFileBulkLoadQBitConfig withSchedulerName(String schedulerName)
   {
      this.schedulerName = schedulerName;
      return (this);
   }
    ...
    *******************************************************************************/
   public ImportFileBulkLoadQBitConfig withSourceFileTableConfig(ProvidedOrSuppliedTableConfig sourceFileTableConfig)
   {
      this.sourceFileTableConfig = sourceFileTableConfig;
      return (this);
   }
    ...
    *******************************************************************************/
   public ImportFileBulkLoadQBitConfig withStagingFileTableConfig(ProvidedOrSuppliedTableConfig stagingFileTableConfig)
   {
      this.stagingFileTableConfig = stagingFileTableConfig;
      return (this);
   }
    ...
    *******************************************************************************/
   public ImportFileBulkLoadQBitConfig withAdditionalFieldsToCopyFromSftpImportConfigToImportFile(Map<String, String> additionalFieldsToCopyFromSftpImportConfigToImportFile)
   {
      this.additionalFieldsToCopyFromSftpImportConfigToImportFile = additionalFieldsToCopyFromSftpImportConfigToImportFile;
      return (this);
   }
    ...
    *******************************************************************************/
   public ImportFileBulkLoadQBitConfig withTableMetaDataCustomizer(MetaDataCustomizerInterface<QTableMetaData> tableMetaDataCustomizer)
   {
      this.tableMetaDataCustomizer = tableMetaDataCustomizer;
      return (this);
   }
